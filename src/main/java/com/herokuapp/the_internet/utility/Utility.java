...
//Thread.sleep(3000);
   ...
   /* public void verifyText(String expectedMessage, By by, String displayMessage) {
    ...
    public void enterValidUserName(String tomsmith) {
    }

    public void enterValidPassword(String s) {
    }
    ...
    public void enterInvalidUserName(String tomsmith1) {
    }

    public void enterInValidPassword(String s) {
    }
